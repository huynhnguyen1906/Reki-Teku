...
import Style from '@styles/appStyles/AboutCompany.module.scss';
        ...
        <div className={Style.bg}>
            <div className={Style.companyWrap}>
                <div className={Style.content}>
                    ...
                    <p>川が大きな流れから小さく枝分かれしていくように、歴史も枝分かれしていきます。<br />
                ...
                <div className={Style.content}>
                    ...
                    <p>いにしえの人物それぞれが歩んだ足跡を訪ね、遺構や文物を目にすると、生き方の助けになる「発見」があります。<br />
                        有名、無名の史跡をてくてくと歩き、「今後の人生の糧」や「地域のより深い魅力」を見つけませんか？<br />
                        また、地域の過去~現在にわたる史跡を巡り、通史を知れば、その地域の「個性」が見えてきます。<br />
                ...
                <div className={Style.content}>
                    ...
                    <div className={Style.flex}>
                        <div className={Style.text}>
                            <p>モラルの低下が懸念される日本社会。<br />
                                歴史に興味を持つことで、先人たちの生き方や失敗から学び、道徳観念を養うことができる。
                            </p>
                            <p>歴史上の人物に焦点を当てたツアーを通じて、彼らの信念や過ちから正しい生き方のヒントを提供し、
                                社会に道徳を取り戻す一助としたい。
                            </p>
                        </div>
                        <div>
