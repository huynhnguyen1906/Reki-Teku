        ...
        <div className={Style.bg}>
            <div className={Style.toursWrap}>
                <div className={Style.toursContent}>
                    ...
                    <h1>古代~室町 博多の歴史</h1>
                    <p>¥~1,5000 1泊2日</p>
                    <p className={Style.text}>福岡は、古来より海外との接点を持ち続けてきた日本で唯一の地です。このツアーでは、福岡に点在する各時代を代表する史跡を巡りながら、
            ...
            <div className={Style.pointWrap}>
                ...
                <div className={Style.pointFlex}>
                    <p className={Style.text}>
                        ...
                        また、福岡古は来から重要な防衛拠点であり、各地に直接足を運ぶため海外との結びつきが強かったことを肌で感じることができます。<br />
                    ...
                    <p className={Style.borderline}></p>
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                ...
                                <p>DAY1_①<span>板付遺跡(博多区)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~日本最古の稲作跡~</p>
                                <p>古代の福岡にタイムスリップ！？<br />弥生時代の集落跡を見学!!</p>
                            </div>
                        </div>
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                <Image src="/images/tours/day1_2.png" alt="水城" width={650} height={366}/>
                                <p>DAY1_②<span>水城(太宰府市)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~古代の防御施設を探索~</p>
                                <p>古代の防御拠点、水城を探訪!!</p>
                        ...
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                ...
                                <p>DAY1_③<span>太宰府天満宮(太宰府市)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~菅原道真公に~祈りを捧げる</p>
                        ...
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                <Image src="/images/tours/day2_1.png" alt="今津元寇防塁" width={650} height={366}/>
                                <p>DAY2_①<span>今津元寇防塁(福岡市)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~元寇の歴史を体感~</p>
                        ...
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                ...
                                <p>DAY2_②<span>志賀島・蒙古塚(福岡市)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~勇敢な防衛の痕跡を探る~</p>
                                <p>元寇の戦死者を祀る蒙古塚!</p>
                        ...
                        <div className={Style.schedContent}>
                            <div className={Style.pic}>
                                <Image src="/images/tours/day2_1.png" alt="今津元寇防塁" width={650} height={366}/>
                                <p>DAY2_③<span>多々良浜の戦い古戦場跡(福岡市)</span></p>
                            </div>
                            <div className={Style.text}>
                                <p>~中世の戦いの跡地を巡る~</p>
